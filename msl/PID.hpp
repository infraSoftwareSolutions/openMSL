...
namespace msl
{
    ...
    public:
        P_controller() noexcept : kp(0.0),
                                  setpoint(0.0), input_function(nullptr) {}
        ...
        void reset_input_function(std::function<double(double)> InputFunction) noexcept
        {
            input_function = InputFunction;
        }
        void reset_kp(double Kp) noexcept
        {
            kp = Kp;
        }
        void reset_setpoint(double Setpoint) noexcept
        {
            setpoint = Setpoint;
        }
        void set(double Kp, double Setpoint,
                 std::function<double(double)> InputFunction) noexcept
        {
            kp = Kp;
            setpoint = Setpoint;
        ...
        constexpr double get_kp() const noexcept
        {
            return kp;
        }
        constexpr double get_setpoint() const noexcept
        {
            return setpoint;
        }
        constexpr std::function<double(double)> get_input_function() const noexcept
        {
        ...
        void compute_over_time(double start_time,
                               double end_time, double time_step) noexcept
        {
        ...
        const std::map<double, double> &get_output_values() const noexcept
        {
        ...
        bool operator!=(const P_controller &other) noexcept
        {
            return !(*this == other);
        }
        void operator=(std::function<double(double)> InputFunction) noexcept
        {
            input_function = InputFunction;
        }
        void operator=(const P_controller &other) noexcept
        {
            if (this != &other)
            {
                kp = other.kp;
        ...
        void operator<<(const I_controller &other) noexcept
        {
            kp = other.get_ki();
        ...
        void operator<<(const D_controller &other) noexcept
        {
            kp = other.get_kd();
            setpoint = other.get_setpoint();
            input_function = other.get_input_function();
        ...
        void operator>>(I_controller &other) noexcept
        {
            other.set(kp, setpoint, input_function);
        }
        void operator>>(D_controller &other) noexcept
        {
            other.set(kp, setpoint, input_function);
        }
    };
    ...
    public:
        ...
        I_controller(double Ki, double Setpoint,
                     std::function<double(double)> InputFunction) noexcept : ki(Ki), setpoint(Setpoint),
                                                                             input_function(InputFunction) {}
        ...
        void reset_ki(double Ki) noexcept
        {
            ki = Ki;
        }
        void reset_setpoint(double Setpoint) noexcept
        ...
        constexpr double get_ki() const noexcept
        {
            return ki;
        }
        void set(double Ki, double Setpoint,
                 std::function<double(double)> InputFunction) noexcept
        {
            ki = Ki;
            setpoint = Setpoint;
        ...
        bool operator!=(const I_controller &other) noexcept
        {
            return !(*this == other);
        }
        bool operator==(const I_controller &other) noexcept
        ...
        void operator>>(P_controller &other) noexcept
        {
            other.set(ki, setpoint, input_function);
        }
        void operator>>(D_controller &other) noexcept
        {
            other.set(ki, setpoint, input_function);
    ...
    public:
        D_controller() noexcept : kd(0.0),
                                  setpoint(0.0), input_function(nullptr) {}
        D_controller(const D_controller &other) noexcept : kd(other.kd),
                                                           setpoint(other.setpoint),
                                                           input_function(other.input_function),
                                                           output_values(other.output_values) {}
        D_controller(double Kd, double Setpoint,
                     std::function<double(double)> InputFunction) noexcept : kd(Kd), setpoint(Setpoint),
                                                                             input_function(InputFunction) {}
        void set(double Kd, double Setpoint,
                 std::function<double(double)> InputFunction) noexcept
        {
            kd = Kd;
            setpoint = Setpoint;
        ...
        constexpr double get_kd() const noexcept
        {
            return kd;
        }
        constexpr double get_setpoint() const noexcept
        ...
        void reset_kd(double Kd) noexcept
        {
            kd = Kd;
        }
        void reset_setpoint(double Setpoint) noexcept
        ...
        bool operator==(const D_controller &other) noexcept
        {
            return (kd == other.kd) &&
                   (setpoint == other.setpoint) &&
                   (input_function.target_type() == other.input_function.target_type()) &&
        ...
        void operator>>(I_controller &other) noexcept
        {
            other.set(kd, setpoint, input_function);
        }
        void operator>>(P_controller &other) noexcept
        {
            other.set(kd, setpoint, input_function);
    ...
    public:
        block_controller() noexcept : state_form(0),
                                      p_controller(), i_controller(), d_controller() {}
